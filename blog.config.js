...
const BLOG = {
  ...
  LINK: process.env.LINK || 'https://www.expoli.tech', // 网站地址
  ...
  CONTACT_EMAIL: process.env.CONTACT_EMAIL, // 邮箱
  CONTACT_WEIBO: process.env.CONTACT_WEIBO, // 你的微博个人主页
  CONTACT_TWITTER: process.env.CONTACT_TWITTER, // 你的twitter个人主页
  CONTACT_GITHUB: process.env.CONTACT_GITHUB || 'https://github.com/expoli', // 你的github个人主页
